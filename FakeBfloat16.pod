...
=head1 OUTPUT FUNCTIONS
   ...
   $obj = pack_bf16_hex($string);
    Convert the string ($string) returned by unpack_bf16_hex()
    into a Math::FakeBfloat16 object whose value is the same as
    the object from which $string was derived.
